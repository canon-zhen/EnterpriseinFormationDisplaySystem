    ...
    <section class="admin-dashboard-section">
        ...
        <%--内容begin --%>
            <div style="float:left;margin:5px">
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/findCategoryByPageServlet">返回</a>
            </div>
            <div class="container" style="width: 400px;">
                <h3 style="text-align: center; font-family: 华文行楷;color: #0e73c2">修改分类信息</h3>

                <form action="${pageContext.request.contextPath}/updateCategoryServlet" method="post">
                    <div class="form-group">
                        <label for="catId">分类编号：</label>
                        <input type="text" class="form-control" id="catId" value="${epCategory.catId}" name="catId" placeholder="请输入分类编号">
                    </div>
                    <div class="form-group">
                        <label for="catName">分类名称：</label>
                        <textarea class="form-control" id="catName" name="catName" placeholder="请输入分类名称">${epCategory.catName}</textarea>
