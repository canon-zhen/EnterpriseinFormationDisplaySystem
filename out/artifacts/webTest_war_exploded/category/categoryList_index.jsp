...
<!--    <link rel="icon" href="assets/img/fevicon.png">-->
    ...
    <script>
        function deleteUser(id) {
            //提示
            if (confirm("您确定要删除吗？")){
                location.href=" ${pageContext.request.contextPath}/deleteCategoryServlet?catId="+id;
            }
        }
    ...
    <section class="admin-dashboard-section">
        ...
        <%--内容begin --%>
            <div class="container" >
                ...
                <h3 style="text-align: center">分类信息列表</h3>
                <div style="float: left;">


                    <form class="form-inline" action="${pageContext.request.contextPath}/findCategoryByPageServlet">
                        <div class="form-group">
                            <label for="exampleInputName2">分类编号</label>
                            <input type="text" name="cat_id" value="${condition.catId[0]}" class="form-control" id="exampleInputName2" >
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName3">分类名称</label>
                            <input type="text" name="cat_name" value="${condition.catName[0]}" class="form-control" id="exampleInputName3" >
                        </div>
                        <%--<div class="form-group">
                ...
                <div style="float:right;margin:5px">
                    ...
                    <c:if test="${loginUser.userRight == 0}">
                        <a class="btn btn-primary" href="category/addCategory_index.jsp">添加分类</a>
                        <a class="btn btn-primary" href="javascript:void(0);" id="delSelected">删除选中</a>
                    </c:if>

                </div>

                <form id="delSelectedForm" action="${pageContext.request.contextPath}/deleteSelectedCategoryServlet" method="post" >
              ...
              private String catName;//分类名称--%>
                        <c:forEach items="${pageBean.list}" var="Category" varStatus="s">
                            <tr>
                                <c:if test="${loginUser.userRight== 1}">
                                    <%--用户--%>
                                </c:if>
                                <c:if test="${loginUser.userRight == 0}">
                                    <td><input type="checkbox" name="selectedId" value="${Category.catId}"></td>
                                </c:if>
                                <td>${s.count}</td>
                                ...
                                <c:if test="${loginUser.userRight == 0}">
                                    <td>
                                        <a class="btn btn-default btn-sm"
                                           href="${pageContext.request.contextPath}/updatefindCategoryServlet?catId=${Category.catId}">修改</a>&nbsp;
                                        <a class="btn btn-default btn-sm"
                                           href="javascript:deleteUser(${Category.catId});">删除</a>
                                    </td>
                                </c:if>
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <c:if test="${pageBean.currentPage ==1}">
                                ...
                                <li class="disabled">
                                    <a href="${pageContext.request.contextPath}/findCategoryByPageServlet?currentPage=${pageBean.currentPage}&rows=9&catId=${condition.catId[0]}&catName=${condition.catName[0]}" aria-label="Previous">
                            ...
                            <c:if test="${pageBean.currentPage !=1}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/findCategoryByPageServlet?currentPage=${pageBean.currentPage-1}&rows=9&catId=${condition.catId[0]}&catName=${condition.catName[0]}" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="1" end="${pageBean.totalPage}" var="i">
                                <c:if test="${pageBean.currentPage ==i}">
                                    <li class="active">
                                        <a href="${pageContext.request.contextPath}/findCategoryByPageServlet?currentPage=${i}&rows=9&catId=${condition.catId[0]}&catName=${condition.catName[0]}">${i}</a></li>
                                </c:if>
                                <c:if test="${pageBean.currentPage !=i}">
                                    <li><a href="${pageContext.request.contextPath}/findCategoryByPageServlet?currentPage=${i}&rows=9&catId=${condition.catId[0]}&catName=${condition.catName[0]}">${i}</a></li>
                                </c:if>
                            ...
                            <c:if test="${pageBean.currentPage ==pageBean.totalPage}">
                                <li class="disabled">
                                    <a href="${pageContext.request.contextPath}/findCategoryByPageServlet?currentPage=${pageBean.currentPage}&rows=9&catId=${condition.catId[0]}&catName=${condition.catName[0]}" aria-label="Next">
                            ...
                            <c:if test="${pageBean.currentPage !=pageBean.totalPage}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/findCategoryByPageServlet?currentPage=${pageBean.currentPage+1}&rows=9&catId=${condition.catId[0]}&catName=${condition.catName[0]}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </li>
                            </c:if>
        ...
        <div class="dashboard-left-menu">
            ...
            <ul>
                ...
                <c:if test="${loginUser.userRight== 1}">
                    ...
                    <li class="nav-item">
                        <a class="dashboard-item-menu active"  href="${pageContext.request.contextPath}/findCategoryByPageServlet"><i class="fas fa-bookmark"></i>查看分类</a>
                    </li>
                    <li class="nav-item">
                ...
                <c:if test="${loginUser.userRight == 0}">
                    ...
                    <li class="nav-item">
                        <a class="dashboard-item-menu active"  href="${pageContext.request.contextPath}/findCategoryByPageServlet"><i class="fas fa-bookmark"></i>管理分类信息</a>
                    </li>
                    <li class="nav-item">
                        <a class="dashboard-item-menu"  href="${pageContext.request.contextPath}/quitServlet"><i class="fas fa-sign-out-alt"></i>退出登录</a>
                    </li>
