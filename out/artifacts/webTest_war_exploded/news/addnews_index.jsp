...
<body class='sc5'>
    ...
    <section class="admin-dashboard-section">
        ...
        <div class="container" style="width: 400px;">
                <center><h3>添加新闻页面</h3></center>
                <form action="${pageContext.request.contextPath}/addNewsServlet" method="post">
                   ...
                   private Date newsDatetime;//发表时间--%>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="newsContent" name="newsContent" placeholder="请输入新闻内容"></textarea>
