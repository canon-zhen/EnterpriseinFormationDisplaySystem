        ...
        <div class="admin-dashboard-right-side">
            ...
            <%--内容begin --%>
                ...
                <div class="container" style="width: 400px;">
                    <h3 style="text-align: center; font-family: 华文行楷;color: #0e73c2">修改联系人</h3>
                    <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
                        <!-- 隐藏域，提交id-->
                        <input type="hidden" name="userId" value="${epUser.userId}">
                        <div class="form-group">
                            <label for="username">用户名：</label>
                            <input type="text" class="form-control" id="username" value="${epUser.userName}" name="userName" placeholder="请输入用户名">
                        </div>
                        <div class="form-group">
                            <label for="password">密码：</label>
                            <input type="password" class="form-control" id="password" value="${epUser.userPwd}" name="userPwd" placeholder="请输入密码">
                        </div>
                        <div class="form-group">
                            <label for="name">姓名：</label>
                            <input type="text" class="form-control" id="name"  value="${epUser.userRname}" name="userRname" placeholder="请输入姓名">
                        </div>
                        <div class="form-group">
                            <label for="email">邮箱：</label>
                            <input type="email" class="form-control" id="email"  value="${epUser.userEmail}" name="userEmail" placeholder="请输入邮箱">
                        </div>
                        <div class="form-group">
                            <label for="company">公司：</label>
                            <input type="text" class="form-control" id="company"  value="${epUser.userCompany}" name="userCompany" placeholder="请输入公司">
                        </div>
                        <div class="form-group">
                            <label for="tel">电话：</label>
                            <input type="text" class="form-control" id="tel" value="${epUser.userTel}" name="userTel" placeholder="请输入电话">
                        </div>
                        <div class="form-group">
                            <label for="fax">传真：</label>
                            <input type="text" class="form-control" id="fax" value="${epUser.userFax}" name="userFax" placeholder="请输入传真">
                        </div>
                        <div class="form-group">
                            <label>权限：</label>
                            <input type="radio" name="userRight" value="0" <c:if test="${epUser.userRight=='0' }">checked="checked"</c:if>  />用户
                            <input type="radio" name="userRight" value="1" <c:if test="${epUser.userRight=='1' }">checked="checked"</c:if>  />管理员
                        </div>
