        ...
        <div class="container" style="width: 400px;">
            ...
            <form action="${pageContext.request.contextPath}/addProductServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="catId" name="catId" placeholder="请输入分类编号">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="prodType" name="prodType" placeholder="请输入产品型号">
                </div>
                <div class="form-group">
                    <label for="prodPrice">产品价格：</label>
                    <input type="text" class="form-control" id="prodPrice" name="prodPrice" placeholder="请输入产品价格">
                </div>
                <div class="form-group">
                    <label for="prodImage">产品图像：</label>
                    <input type="file" class="form-control" id="prodImage" name="prodImage" placeholder="请选择产品图像">
                </div>
                <div class="form-group">
                    <label for="prodDesc">产品简介：</label>
                    <input type="text" class="form-control" id="prodDesc" name="prodDesc" placeholder="请输入产品简介">
                </div>

                <div class="form-group">
                    <label>是否添加到首页：</label>
                    <input type="radio" name="prodFirstShow" value="1" checked="checked"/>是
                    <input type="radio" name="prodFirstShow" value="0"/>否
                </div>
