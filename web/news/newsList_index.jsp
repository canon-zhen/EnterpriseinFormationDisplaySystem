...
<!--    <link rel="icon" href="assets/img/fevicon.png">-->
    ...
    <script>
        function deleteUser(id) {
            //提示
            if (confirm("您确定要删除吗？")){
                location.href=" ${pageContext.request.contextPath}/deleteNewsServlet?newsId="+id;
            }
        }
    ...
    <section class="admin-dashboard-section">
        ...
        <%--内容begin --%>
            <div class="container" >
                ...
                <h3 style="text-align: center">新闻列表</h3>
                <div style="float: left;">
                    <form class="form-inline" action="${pageContext.request.contextPath}/findNewsByPageServlet">
                        <div class="form-group">
                            ...
                            <input type="text" name="news_title" value="${condition.newsTitle[0]}" class="form-control" id="exampleInputName2" >
                        </div>
                        <div class="form-group">
                            <label for="exampleInputName3">新闻内容</label>
                            <input type="text" name="news_content" value="${condition.newsContent[0]}" class="form-control" id="exampleInputName3" >
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail2">新闻时间</label>
                            <input type="text" name="news_datetime" value="${condition.newsDatetime[0]}" class="form-control" id="exampleInputEmail2" >
                        </div>
                ...
                <div style="float:right;margin:5px">
                    ...
                    <c:if test="${loginUser.userRight == 0}">
                        <a class="btn btn-primary" href="news/addnews_index.jsp">添加新闻</a>
                ...
                private Date newsDatetime;//发表时间--%>
                        <c:forEach items="${pageBean.list}" var="news" varStatus="s">
                            <tr>
                                ...
                                <c:if test="${loginUser.userRight == 0}">
                                    <td><input type="checkbox" name="selectedId" value="${news.newsId}"></td>
                                </c:if>
                                ...
                                <c:if test="${loginUser.userRight == 0}">
                                    <td><a class="btn btn-default btn-sm"
                                           href="${pageContext.request.contextPath}/updatefindNewsServlet?newsId=${news.newsId}">修改</a>&nbsp;
                                        <a class="btn btn-default btn-sm"
                                           href="javascript:deleteUser(${news.newsId});">删除</a></td>
                                </c:if>
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <c:if test="${pageBean.currentPage ==1}">
                                ...
                                <li class="disabled">
                                    <a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${pageBean.currentPage}&rows=9&newsTitle=${condition.newsTitle[0]}&newsContent=${condition.newsContent[0]}&newsDatetime=${condition.newsDatetime[0]}" aria-label="Previous">
                            ...
                            <c:if test="${pageBean.currentPage !=1}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${pageBean.currentPage-1}&rows=9&newsTitle=${condition.newsTitle[0]}&newsContent=${condition.newsContent[0]}&newsDatetime=${condition.newsDatetime[0]}" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                    </a>
                                </li>
                            </c:if>
                            ...
                            <c:forEach begin="1" end="${pageBean.totalPage}" var="i">
                                <c:if test="${pageBean.currentPage ==i}">
                                    <li class="active">
                                        <a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${i}&rows=9&newsTitle=${condition.newsTitle[0]}&newsContent=${condition.newsContent[0]}&newsDatetime=${condition.newsDatetime[0]}">${i}</a></li>
                                </c:if>
                                <c:if test="${pageBean.currentPage !=i}">
                                    <li><a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${i}&rows=9&newsTitle=${condition.newsTitle[0]}&newsContent=${condition.newsContent[0]}&newsDatetime=${condition.newsDatetime[0]}">${i}</a></li>
                                </c:if>
                            ...
                            <c:if test="${pageBean.currentPage ==pageBean.totalPage}">
                                <li class="disabled">
                                    <a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${pageBean.currentPage}&rows=9&newsTitle=${condition.newsTitle[0]}&newsContent=${condition.newsContent[0]}&newsDatetime=${condition.newsDatetime[0]}" aria-label="Next">
                            ...
                            <c:if test="${pageBean.currentPage !=pageBean.totalPage}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/findNewsByPageServlet?currentPage=${pageBean.currentPage+1}&rows=9&newsTitle=${condition.newsTitle[0]}&newsContent=${condition.newsContent[0]}&newsDatetime=${condition.newsDatetime[0]}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </li>
                            </c:if>
        ...
        <div class="dashboard-left-menu">
            ...
            <ul>
                ...
                <c:if test="${loginUser.userRight== 1}">
                    ...
                    <li class="nav-item">
                        <a class="dashboard-item-menu active"  href="${pageContext.request.contextPath}/findNewsByPageServlet"><i class="fas fa-graduation-cap"></i>查看新闻</a>
                    </li>
                    <li class="nav-item">
                ...
                <c:if test="${loginUser.userRight == 0}">
                    ...
                    <li class="nav-item">
                        <a class="dashboard-item-menu active"  href="${pageContext.request.contextPath}/findNewsByPageServlet"><i class="fas fa-graduation-cap"></i>管理新闻信息</a>
                    </li>
                    <li class="nav-item">
