        ...
        <%--内容begin --%>
            <div style="float:left;margin:5px">
                <c:if test="${loginUser.userRight== 1}">
                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/findNewsByPageServlet">返回主页</a>
                </c:if>
            ...
            <div class="container" style="width: 400px;">
                <h3 style="text-align: center; font-family: 华文行楷;color: #0e73c2">修改新闻信息</h3>
              ...
              private Date newsDatetime;//发表时间--%>
                <form action="${pageContext.request.contextPath}/updateNewsServlet" method="post">
                    <!-- 隐藏域，提交id-->
                    <input type="hidden" name="newsId" value="${epNews.newsId}">

                    <div class="form-group">
                        <label for="newsTitle">新闻标题：</label>
                        <input type="text" class="form-control" id="newsTitle" value="${epNews.newsTitle}" name="newsTitle" placeholder="请输入新闻标题">
                    </div>
                    <div class="form-group">
                        <label for="newsContent">新闻内容：</label>
                        <textarea class="form-control" id="newsContent" name="newsContent" placeholder="请输入新闻内容">${epNews.newsContent}</textarea>
                        <%--            <input style="height: 500px;" type="text" class="form-control" id="newsContent" value="${epNews.newsContent}" name="newsContent" placeholder="请输入新闻内容">--%>
                    </div>
